...
class Generator extends \yii\gii\Generator
{
     ...
     * @var string[]
     */
    public $imagesColumnNames = ['image', 'photo', 'picture', 'avatar', 'logo', 'icon'];
    ...
    public function generateRules($table)
    {
        ...
        foreach ($table->columns as $column) {
            ...
            switch ($column->type) {
                ...
                case Schema::TYPE_JSON:
                    ...
                    break;
                default: // strings
                    if (in_array($column->name, $this->imagesColumnNames)) {
        ...
        foreach ($types as $type => $columns) {
            ...
            if ($type === 'active') {
                $rules[] = "[['" . implode("', '", $columns) . "'], 'in', 'range' => [0, 1]]";
                $rules[] = "[['" . implode("', '", $columns) . "'], 'default', 'value' => 1]";
            } else {
